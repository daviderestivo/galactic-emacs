...
The following is the list of the included packages. Packages
dependencies are not listed.

The package management tool used is: [use-package](https://github.com/jwiegley/use-package).
...
* [treemacs-magit](https://github.com/Alexander-Miller/treemacs#treemacs-magit)
...
* [whitespace](https://www.gnu.org/software/emacs/manual/html_node/emacs/Useless-Whitespace.html)
